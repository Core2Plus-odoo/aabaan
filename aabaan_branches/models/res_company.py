...
class ResCompany(models.Model):
    ...
    def _cron_aabaan_licence_expiry(self):
        ...
        for company in self.search([
            ...
            # an open renewal activity blocks duplicates regardless of its
            # deadline — an expired licence must not re-alert every day
            ...
            partner.activity_schedule(
                ...
                date_deadline=max(
                    today, min(company.aabaan_licence_expiry, horizon)),
                summary=summary,
